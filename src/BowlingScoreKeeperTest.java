...
public class BowlingScoreKeeperTest {
	...
	@Test
	public void canGetProperScoreOfAGameWithSpareFrame() {
		Game g = new Game();
		g.roll(1, 9);
		assertTrue(g.getFrame(1).isSpare());
		g.roll(3, 6);
		assertThat(g.getFrameScore(1), is(13));
	}
	...
	@Test
	public void canGetValidScoreForGameWithSpare() {
